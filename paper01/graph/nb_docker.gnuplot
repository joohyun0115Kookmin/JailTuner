...
plot \
"./data/nb_default.data" every :::0::0 with lp title "naive bayes", \
"./data/nb_8.data" every :::0::0 with lp title "naive bayes per lock", \
"./data/nb_15.data" every :::0::0 with lp title "naive bayes per socket"
